/* Define data types and macros for VS solver programs.
   ...
   Revision Log
   ------------  
   Jan 10, 11. C. Berry. Support for 2D table that is list of 1D tables.
   Dec 07, 10. M. Sayers. Added equation option to tables
   Jun 22, 10. M. Sayers. Put test for _MSC_VER in debug memory leak check
   May 06, 10. M. Sayers. Added start_x to table structure.
   Apr 21, 10. M. Sayers. Added VS_EXT_EQ_SAVE.
   Apr 01, 10. M. Sayers. more macros for MSVC to support check for memory leaks
   ...
   Jan 07, 07. M. Sayers. Removed vs_target.h (later put back...)
...
*/
  ...
  typedef enum 
    ...
    VS_EXT_EQ_PRE_INIT, VS_EXT_EQ_INIT2, VS_EXT_EQ_SAVE
    } vs_ext_loc;
  ...
  typedef enum 
    ...
    VS_TAB_STEP, VS_SPLINE, VS_SPLINE_LOOP, VS_SPLINE_FLAT, 
    VS_TAB_2D, VS_TAB_2D_LOOP, VS_TAB_2D_STEP, VS_TAB_2D_FROM_ZERO, 
    VS_TAB_2D_SPLINE, VS_TAB_2D_INDEP_COLS, VS_TAB_2D_VAR_WIDTH_STEP, 
    VS_TAB_2D_VAR_WIDTH, VS_TAB_EQ
    } vs_table_type;
  ...
  typedef enum 
    ...
    PAR_INIT, ISYM_INIT, SYS_PAR_INIT // added Jan 28, 2011. Needed for init?
    } vs_sym_attr_type;
  ...
  typedef enum 
    ...
    VS_KEYWORD_TAB_GROUP_START_X, VS_KEYWORD_TAB_START_X,
    VS_KEYWORD_TAB_GROUP_SCALE_X, VS_KEYWORD_TAB_SCALE_X, 
  ...
  typedef struct
    ...
    vs_real gain, offset, start_x, scale_x; // used to transform almost any table
  ...
  typedef struct _vs_tab_group_
    ...
    char *gain_keyword, *offset_keyword, *start_x_keyword, *scale_x_keyword;
