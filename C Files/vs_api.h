...
int vs_get_api (HMODULE dll, char *dll_fname);

int vs_get_api_basic (HMODULE dll, char *dll_fname); // legacy
int vs_get_api_extend (HMODULE dll, char *dll_fname); // legacy
int vs_get_api_road (HMODULE dll, char *dll_fname); // legacy
int vs_get_api_install_external (HMODULE dll, char *dll_fname); // legacy

// simple run function (chapter 2)
int      (__cdecl *vs_run) (char *simfile);

// managing import/export arrays (chapter 4)
void     (__cdecl *vs_copy_export_vars) (vs_real *export);
void     (__cdecl *vs_copy_import_vars) (vs_real *import);
